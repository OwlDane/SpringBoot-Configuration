package belajar_spring_configuration.spring_configuration.configurationproperties;
...
public class ConfigurationPropertiesTest {
    ...
    void testDatabaseProperties() {
        Assertions.assertEquals("zidane", properties.getDatabase().getUsername());
    ...
    void testCustomConverter() {
        ...
        Assertions.assertEquals("2025-03-05", dateFormat.format(expireDate));
    }
    ...
    public ConversionService conversionService(StringToDateConverter stringToDateConverter){
            ...
            conversionService.addConverter((Converter<?, ?>) stringToDateConverter);
